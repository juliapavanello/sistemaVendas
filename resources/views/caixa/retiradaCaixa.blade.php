    ...
    <div class="cadastro-container">
        ...
        <div class="formulario">
            ...
            <div class="etapa-formulario" id="etapa-1">
                ...
                <label for="nome">Insira a quantidade dinheiro retirado<span class="obrigatorio">*</span></label>
                <input type="text" id="nome" placeholder="R$ 0,00" style="width: 40%;">

                <label for="descricao">Motivo de retirada</label>
                <textarea id="descricao" placeholder="Insira o motivo da retirada de caixa"></textarea>
            ...
            <div class="etapa-formulario" id="etapa-2" style="display: none">
                ...
                <p class="aviso">Ao confirmar a retirada de caixa, o sistema registra essa retirada com o <span class="rosa">seu usuário</span> e <span class="rosa">data atual</span>. Use
