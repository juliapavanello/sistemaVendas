        ...
        <div class="lista">
            ...
            <div class="items-lista {{ $i=1 }}">
                @foreach($produtos as $item)
                    <div class="item-lista pg-{{ ceil(($i++)/$qtdPorPg) }}" @if($item->id >= $produtos[$qtdPorPg]->id) style="display: none" @endif>
                        <div class="campo" style="width: 21%; text-align: start;">
                            <p>{{ $item->nome }}</p>
                        </div>
                        <div class="campo" style="width: 33%; text-align: start;">
                        ...
                        <div class="campo"
                            ...
                            <!--icones deletar e excluir-->
                            <svg width="20" height="20" onclick="window.location='{{ route('produtos.edit', $item->id) }}'" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
